...
First modification by: https://github.com/bernhard2202/improved-video-gan/blob/master/extra/split.py

Modified by: Florian Mahner
"""
...
""" Entire script is working based on a <file> job-list.txt that was creater after running 
<file> download_plain.py and saving into <dir> global_dir """

# Change this global directory to the video directory
global_dir = '/'
glob_count = 1
